...
import BreakfastMenu from '../Data/BLD.js'
import LDMenu from '../Data/LunchDinnerMenu.js'
import SidesMenu from '../Data/Sides.js'

function Menu() {
  const [activeCategory, setActiveCategory] = useState('BreakfastMenu')
  ...
  const menuItems = useMemo(() => {
    ...
    return menuMap[activeCategory] || BreakfastMenu
  }, [activeCategory])
  ...
  return (
    <section id='menu' className="py-12 px-4 sm:px-6 md:px-12 lg:px-24">
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-10">
        {['BreakfastMenu', 'LunchDinner', 'Sides'].map((category) => (
          <button
            key={category}
